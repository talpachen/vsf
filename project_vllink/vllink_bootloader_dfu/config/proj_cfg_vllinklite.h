...
#   define APP_CFG_USBD_BCD                             0x0003
...
#   define FIRMWARE_AREA_SIZE_MAX                       (32 * 1024 - 8 * 1024)
#   define FIRMWARE_SP_ADDR			                    (0x20000000 + 4)
#   define FIRMWARE_SP_SIZE_MAX		                    (4 * 1024 - 4)
...
#   endif
#elif defined(BRD_CFG_VLLINKLITE_GD32E103)
#   define APP_CFG_USBD_VID                             0x1209
#   define APP_CFG_USBD_PID                             0x6666
