...
set(CMAKE_C_FLAGS 
  "-mthumb -mcpu=${VSF_ARCH_NAME} -mfloat-abi=${ARM_FLOATING_ABI} ${ARM_FLOATING_HARDWARE} \
...
set(CMAKE_ASM_FLAGS "-mthumb -mcpu=${VSF_ARCH_NAME}" CACHE INTERNAL "asm compiler flags")
