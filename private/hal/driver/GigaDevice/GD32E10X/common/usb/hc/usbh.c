...
extern vsf_err_t gd32e10x_usb_init(gd32e10x_usb_t *usb, vsf_arch_prio_t priority);
extern void gd32e10x_usb_irq(gd32e10x_usb_t *usb);
...
vsf_err_t gd32e10x_usbh_init(gd32e10x_usb_t *hc, usb_hc_ip_cfg_t *cfg)
{
    ...
    return gd32e10x_usb_init(hc, cfg->priority);
}
